...
public abstract class WeatheringLanternMixin extends LanternBlock implements WeatheringCopper {

    public WeatheringLanternMixin(Properties properties) {
        super(properties);
    }
...
public class WeatheringLanternMixin {}
#endif