...
public abstract class WeatheringCopperBulbMixin extends CopperBulbBlock implements WeatheringCopper {

    public WeatheringCopperBulbMixin(Properties properties) {
        super(properties);
    }
...
public class WeatheringCopperBulbMixin {}
#endif