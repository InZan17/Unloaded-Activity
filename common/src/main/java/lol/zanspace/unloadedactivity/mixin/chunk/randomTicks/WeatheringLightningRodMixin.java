...
@Mixin(WeatheringLightningRodBlock.class)
public abstract class WeatheringLightningRodMixin extends LightningRodBlock implements WeatheringCopper {

    public WeatheringLightningRodMixin(Properties properties) {
        super(properties);
    }
...
public class WeatheringLightningRodMixin {}
#endif