...
public abstract class OxidizableCopperChestMixin extends CopperChestBlock implements Oxidizable {

    public OxidizableCopperChestMixin(OxidationLevel oxidationLevel, SoundEvent openSound, SoundEvent closeSound, Settings settings) {
    ...
    @Override public boolean canSimulateRandTicks(BlockState state, ServerWorld world, BlockPos pos) {
        ...
        if (state.get(ChestBlock.CHEST_TYPE).equals(ChestType.RIGHT)) return false;
