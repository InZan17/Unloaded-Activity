...
public abstract class OxidizableCopperGolemStatueMixin extends CopperGolemStatueBlock implements Oxidizable {


    public OxidizableCopperGolemStatueMixin(OxidationLevel oxidationLevel, Settings settings) {
