...
public abstract class OxidizableLightningRodBlockMixin extends LightningRodBlock implements Oxidizable {

    public OxidizableLightningRodBlockMixin(Settings settings) {
        super(settings);
    }
