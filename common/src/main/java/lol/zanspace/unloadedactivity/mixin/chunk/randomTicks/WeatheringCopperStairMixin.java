...
public abstract class WeatheringCopperStairMixin extends StairBlock implements WeatheringCopper {

    protected WeatheringCopperStairMixin(BlockState blockState, Properties properties) {
